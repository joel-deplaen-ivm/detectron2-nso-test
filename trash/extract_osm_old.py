"""
JDP:Combo of Sadhana's (shapely function) and Elco's (the rest) script + change in the substation function
...
#This file is used to overide the gdal one in conda env - file added
...
def save_df_to_shp (dataframe, file_name):
